-- Achado da revisao de QA (Quinn): nao havia limite maximo de datas por
-- chamada, permitindo que alguem manipulando a requisicao diretamente (fora
-- da UI, que limita a um mes por vez) criasse um numero arbitrario de
-- escalas de uma so vez. Limita a 60 datas por chamada (bem acima de
-- qualquer uso real de um mes).
