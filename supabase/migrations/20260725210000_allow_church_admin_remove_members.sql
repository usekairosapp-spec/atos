-- Permite que administradores da igreja removam membros de departamentos
drop policy if exists "department memberships managed by leaders" on public.department_memberships;

create policy "department memberships managed by leaders and admins" on public.department_memberships
