-- A administradora responsável pela igreja também supervisiona as escalas.
-- Centralizar esta regra evita que igrejas novas dependam de vínculos manuais extras.
