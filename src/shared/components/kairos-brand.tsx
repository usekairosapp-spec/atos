  ...
  return <span className="inline-flex items-center">
    {compact
      ...
      : <span className={`inline-flex flex-col rounded-xl px-3 py-2 ${light ? "bg-white/8 ring-1 ring-white/10" : "bg-[#00294f] shadow-md"}`}>
        ...
        <small className={`mt-1 text-center text-[8px] font-semibold uppercase tracking-[.09em] ${light ? "text-white/65" : "text-blue-100/75"}`}>Agenda de Times, Organização e Serviço</small>
      </span>}
  </span>;
}
