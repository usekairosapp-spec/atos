...
export function SwapRequestForm({ assignmentId, scheduleId, candidates }: { assignmentId: string; scheduleId: string; candidates: Candidate[] }) {
  ...
  return <form action={requestAssignmentSwap} className="mt-7">
    ...
    <h2 className="text-xl font-bold">Selecione alguém para trocar</h2><p className="mt-1 text-sm text-[#6b767d]">Você pode escolher alguém do setor que já esteja em outra função nesta escala. Ao aceitar, a pessoa ficará com as duas funções. A pessoa escolhida receberá o convite e poderá aceitar ou recusar diretamente.</p>
