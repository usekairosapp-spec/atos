...
export function SwapRequestForm({ assignmentId, scheduleId, candidates }: { assignmentId: string; scheduleId: string; candidates: Candidate[] }) {
  ...
  return <form action={requestAssignmentSwap} className="mt-7">
    ...
    <h2 className="text-xl font-bold">Selecione alguém para trocar</h2><p className="mt-1 text-sm text-[#6b767d]">Só aparece quem está disponível nesse dia e horário. A pessoa escolhida receberá o convite e poderá aceitar ou recusar diretamente.</p>
