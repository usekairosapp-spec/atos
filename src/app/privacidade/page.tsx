...
export const metadata: Metadata = {
  ...
  description: "Política de Privacidade do Kairos Escala.",
};
    ...
    <main className="min-h-screen bg-[var(--background)] px-5 py-8 text-[var(--foreground)] sm:px-8">
      <article className="mx-auto max-w-3xl rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm sm:p-10">
        ...
        <div className="mt-9 space-y-8 leading-7 text-[var(--muted)]">
          <section>
            <h2 className="text-xl font-bold text-[var(--foreground)]">1. Sobre o Kairos Escala</h2>
            <p className="mt-2">O Kairos Escala — Agenda de Times, Organização e Serviço — ajuda igrejas a organizar equipes, escalas, confirmações, trocas e comunicados. Esta política explica como os dados pessoais são tratados durante o uso da plataforma.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Quando você escolhe entrar com Google, usamos as informações básicas autorizadas por você, como nome, e-mail e identificação da conta, para autenticar e manter sua sessão no Kairos Escala.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[var(--foreground)]">4. Google Agenda</h2>
            <p className="mt-2">A integração com o Google Agenda é opcional. Quando você solicita a conexão, o Kairos Escala pede somente a permissão necessária para criar e gerenciar eventos de escala adicionados pelo próprio aplicativo em seu calendário.</p>
            <p className="mt-2">Usamos essa permissão para criar, atualizar, recriar ou remover o evento vinculado quando necessário, incluindo data, horário, igreja, setor, função e lembretes. O Kairos Escala não lê nem compartilha outros eventos do seu calendário para fins publicitários.</p>
