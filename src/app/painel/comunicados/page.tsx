...
export default async function AnnouncementsPage() {
  ...
  return <main className="mx-auto max-w-6xl px-5 py-8 sm:px-8"><p className="text-sm font-semibold uppercase tracking-[.15em] text-[var(--church-brand)]">Comunicados</p><h1 className="mt-2 text-3xl font-bold">{canPublish ? "Gerenciar comunicados" : "Meus comunicados"}</h1><section className="mt-8 rounded-[1.75rem] border border-dashed border-[#c6d2df] bg-white p-8 text-center"><p className="font-semibold">{canPublish ? "Você poderá publicar avisos apenas para as equipes autorizadas." : "Aqui você receberá os avisos dos líderes."}</p></section></main>;
}
