...
import { publishSchedule, respondToPeerSwap, updateSchedule } from "@/features/schedules/actions";
...
export default async function ScheduleDetailPage({ params, searchParams }: PageProps) {
  ...
  const [{ data: positions }, { data: members }, { data: assignmentRows }, { data: swapRequests }, { data: ownAssignmentRows }, { data: receivedSwapRequests }] = await Promise.all([
